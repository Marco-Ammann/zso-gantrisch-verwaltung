...
export class PersonFormComponent implements OnInit {
  ...
  private patchPersonForm(person: Person): void {
    ...
    this.patchFormArray(
      ...
      person.zivilschutz.zusatzausbildungen
    );
    this.patchFormArray(
      'persoenliches.sprachkenntnisse',
      person.persoenliches.sprachkenntnisse
    );
    this.patchFormArray(
      'persoenliches.allergien',
      person.persoenliches.allergien
    );
    this.patchFormArray(
      'persoenliches.essgewohnheiten',
      person.persoenliches.essgewohnheiten
    );
    this.patchFormArray(
      'persoenliches.besonderheiten',
      person.persoenliches.besonderheiten
    );
    this.patchFormArray(
      'berufliches.führerausweisKategorie',
      person.berufliches.fuehrerausweisKategorie
    );
  }
